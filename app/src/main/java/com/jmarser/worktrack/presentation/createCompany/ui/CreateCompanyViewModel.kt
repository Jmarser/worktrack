...
class CreateCompanyViewModel @Inject constructor(
    ...
    fun onEvent(event: CreateCompanyEvent){
        when(event){
            ...
            CreateCompanyEvent.onRegisterCompany -> registerCompany()
    ...
    private fun setFullTimePrice(precio: String){
        ...
        val error = when{
            ...
            !validateForm.isRelationPriceValid(filteredPrice, _formState.value.halfTimePrice) -> ValidationError.FullPriceRelationError
            else -> null
        }
    ...
    private fun setHalfTimePrice(precio: String){
        ...
        val error = when{
            !validateForm.validateFieldNotEmpty(filteredPrice) -> ValidationError.EmptyField
            !validateForm.isValidPrice(filteredPrice) -> ValidationError.InvalidFormat
            !validateForm.isRelationPriceValid(filteredPrice, _formState.value.halfTimePrice) -> ValidationError.HalfPriceRelationError
            else -> null
        }
